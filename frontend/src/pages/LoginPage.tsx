...
const LoginPage = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    toast({
      ...
      description:
        "Staff portal login is not yet connected. Contact your administrator.",
    });
  };
      ...
      <div className="hidden lg:flex lg:w-1/2 flex-col justify-between p-12 xl:p-16">
        ...
        <div>
          ...
          <p className="font-body text-white/50 leading-relaxed max-w-md">
            ...
            tools. All activity is logged and monitored to protect resident
            privacy.
          </p>
        </div>
          ...
          >
            ...
            <p className="font-body text-xs text-muted-foreground text-center mt-4">
              ...
              <button
                ...
                className="text-accent hover:text-teal-light transition-colors font-medium"
              >
